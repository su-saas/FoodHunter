...
var App = /** @class */ (function () {
    ...
    App.prototype.routes = function () {
        ...
        /******** Restaurant Dish********/
        router.get('/menu/:restaurantID', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var id, dish;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.restaurantID;
                        console.log('restaurant id:' + id);
                        return [4 /*yield*/, this.Dish.retrieveDishDetails({ restaurantID: id })];
                    case 1:
                        dish = _a.sent();
        ...
        router.put('/menu/:restaurantID', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var id, success;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.restaurantID;
                        console.log('restaurant id:' + id);
                        return [4 /*yield*/, this.Dish.updateDish({ restaurantID: id }, req.body)];
                    case 1:
                        success = _a.sent();
        ...
        router["delete"]('/menu/:restaurantID', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var id, success;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.restaurantID;
                        console.log('restaurant id:' + id);
                        return [4 /*yield*/, this.Dish.deleteDish({ restaurantID: id })];
                    case 1:
                        success = _a.sent();
        ...
        /******** Restaurant Tags********/
        router.get('/tags/:restaurantID', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var id, rtaglist;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.restaurantID;
                        console.log('restaurant id:' + id);
                        return [4 /*yield*/, this.rTagList.retrieverTagListDetails({ restaurantID: id })];
                    case 1:
                        rtaglist = _a.sent();
        ...
        router.put('/tags/:restaurantID', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var id, success;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.restaurantID;
                        console.log('restaurant id:' + id);
                        return [4 /*yield*/, this.rTagList.updaterTagList({ restaurantID: id }, req.body)];
                    case 1:
                        success = _a.sent();
                        console.log('update dish: ' + success);
                        res.status(200).send(success);
        ...
        router["delete"]('/tags/:restaurantID', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var id, success;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.restaurantID;
                        console.log('restaurant id:' + id);
                        return [4 /*yield*/, this.rTagList.deleterTagList({ restaurantID: id })];
                    case 1:
                        success = _a.sent();
                        console.log('delete dish: ' + success);
                        res.status(200).send(success);
